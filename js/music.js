var songs = ["传奇1(弹奏).mp3","传奇2(弹奏).mp3","给我一首歌的时间(弹奏).mp3",
"红尘客栈(弹奏).mp3", "慢慢.mp3", "明明就(弹奏).m4a","明明就(弹奏)2.m4a",
"那些年.mp3","情歌(弹奏).mp3","人质.mp3", "人质(弹奏).mp3","圣诞快乐(弹奏).mp3","天马座の幻想(弹奏).mp3",
"突然好想你(弹奏).mp3","下一个天亮(弹奏).mp3","夜空中最亮的星.mp3",
